...
\hypersetup{
 pdfauthor={Christian Cuaspa, Danny Lanchimba, Steven Echeverria, Dylan Zuñiga},
...
\hline
Emacs(Christian Cuaspa) & Ejecución de C-c C-c fallida & Ejecucion Eval expresion y luego introducir (org-babel-do-load-languages 'org-babel-load-languages '((shell . t) (python . t)))\\[0pt]
 &  & \\[0pt]
 &  & \\[0pt]
\end{tabularx}
\end{center}
...
\endlastfoot
\hline
\texttt{M-d} & Elimina la siguiente palabra despues del cursor & \texttt{C-<SPC>} & Selciona el contenido desde la posición actual del cursor hasta su nueva posición\\[0pt]
\texttt{M-k} & Elimina hasta el final de una oración & \texttt{C-w} & Elimina lo seleccionado con C-<SPC>\\[0pt]
\texttt{C-/} & Deshace una acción & \texttt{C-x C-b} & Muestra la lista de buffers\\[0pt]
\end{longtable}
...
\begin{center}
\includegraphics[width=.9\linewidth]{./images/Intento1_Christian.png}
\end{center}
\begin{center}
\includegraphics[width=.9\linewidth]{./images/Intento2_Christian.png}
\end{center}
\begin{center}
\includegraphics[width=.9\linewidth]{./images/Intento3_Christian.png}
\end{center}
...
\begin{enumerate}
\item \textbf{\textbf{Christian Cuaspa:}} <C-x 1>. <C-x 1 runs the command delete-other-windows (found in global-map),
...
\item \textbf{\textbf{Estudiante C:}} <Poner el comando>. <Pegar lo que dice el primer párrafo de la ayuda>
\item \textbf{\textbf{Estudiante D:}} <Poner el comando>. <Pegar lo que dice el primer párrafo de la ayuda>
\end{enumerate}

\textbf{\textbf{Comandos Difíciles}}
\begin{enumerate}
\item \textbf{\textbf{Estudiante A:}} <M-x recover-file>. <recover-file is an interactive native-compiled Lisp function
in ‘files.el’.>
\item \textbf{\textbf{Estudiante B:}} <Poner el comando>. <Pegar lo que dice el primer párrafo de la ayuda>
\item \textbf{\textbf{Estudiante C:}} <Poner el comando>. <Pegar lo que dice el primer párrafo de la ayuda>
\item \textbf{\textbf{Estudiante D:}} <Poner el comando>. <Pegar lo que dice el primer párrafo de la ayuda>
...
\hline
Christian Cuaspa & christian.cuaspa@epn.edu.ec & líder\\[0pt]
Danny Lanchimba & danny.lanchimba@epn.edu.ec & colaborador\\[0pt]
Dylan Zuñiga & dylan.zuniga@epn.edu.ec & colaborador\\[0pt]
Steven Echeverria & steven.echeverria@epn.edu.ec & colaborador\\[0pt]
 &  & \\[0pt]
\hline
\end{tabular}
\end{center}
